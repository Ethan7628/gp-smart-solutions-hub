  ...
  head: () => ({
    meta: [
      { title: "Beauty & Salon — GP Smart Solutions" },
      {
        name: "description",
        content:
          "Luxurious salon experience in Kampala: haircuts, styling, hair treatments, nail care, beard grooming, facials and premium cosmetics. Book your appointment today.",
      },
      { name: "robots", content: "index, follow" },
      {
        name: "keywords",
        content:
          "salon Kampala, haircuts Uganda, hair styling, hair treatment, nails pedicure, beard grooming, facials, cosmetics, makeup, GP Unixes Saloon, beauty salon Uganda",
      },
      { property: "og:title", content: "Beauty & Salon — GP Smart Solutions" },
      {
        property: "og:description",
        content: "Haircuts, treatments, nails, beard grooming and premium cosmetics in Kampala.",
      },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://gpsmartsolutions.co.ug/beauty" },
      { property: "og:site_name", content: "GP Smart Solutions" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Beauty & Salon — GP Smart Solutions" },
      {
        name: "twitter:description",
        content: "Luxurious salon experience in Kampala: haircuts, nails, treatments and more.",
      },
    ],
...
const categories = [
  {
    ...
    desc: "Precision cuts, blow-dry, updos and event styling.",
    price: "from UGX 25,000",
  },
  {
    icon: Sparkles,
    title: "Hair Treatment",
    desc: "Deep conditioning, keratin, scalp therapy, coloring.",
    price: "from UGX 60,000",
  },
  {
    icon: Palette,
    title: "Nails & Pedicure",
    desc: "Manicure, pedicure, gel, acrylic and nail art.",
    price: "from UGX 30,000",
  },
  {
    icon: Heart,
    title: "Beard Grooming",
    desc: "Sharp beard designs, hot towel and facial care.",
    price: "from UGX 20,000",
  },
  {
    icon: Sparkles,
    title: "Facials & Skincare",
    desc: "Cleansing, exfoliation, masks and glow treatments.",
    price: "from UGX 45,000",
  },
  {
    icon: Palette,
    title: "Cosmetics & Makeup",
    desc: "Bridal, event and everyday makeup by senior stylists.",
        ...
        <div className="container-app py-20 md:py-28">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
              From precision haircuts to luxurious treatments, our senior stylists deliver a premium
              salon experience tailored to how you want to look and feel.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button
                asChild
                size="lg"
                className="h-12 px-6 shadow-beauty text-white bg-gradient-beauty hover:opacity-95"
              >
                <Link to="/contact">
      ...
      <section className="container-app pb-16">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          {[
            {
              src: salonTeam,
              alt: "GP Unisex Salon stylists working on clients — barbering, braiding and blow-dry",
            },
            {
              src: salonTeamBack,
              alt: "GP Unisex Salon team wearing branded uniforms — GP Unisex Saloon 0784 084301",
            },
          ].map((p, i) => (
            <motion.figure
              key={i}
      ...
      <section className="container-app pb-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-bold tracking-tight">
              A luxury nail experience by{" "}
              <span className="gradient-text-beauty">GP Unixes Saloon</span>
            </h2>
            ...
            <div className="mt-8">
              ...
              >
                <Link to="/contact">
                  <Calendar className="mr-2 h-4 w-4" /> Book Your Appointment
                </Link>
              </Button>
            </div>
          </motion.div>
          ...
          {[
            {
              ...
              desc: "Trained professionals with years of styling experience.",
            },
            {
              icon: Clock,
              title: "On-Time Service",
              desc: "Punctual appointments — your time is respected.",
            },
            {
              icon: Sparkles,
              title: "Premium Products",
              desc: "Only trusted, professional-grade beauty products.",
            },
          ].map((f) => (
