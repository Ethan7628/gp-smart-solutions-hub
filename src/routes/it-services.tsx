      ...
      <section className="container-app pb-24">
            ...
            {productCategories.map((cat, ci) => (
              ...
              >
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold group-hover:text-brand transition">
                      {cat.title}
                    </h3>
        ...
        <div className="mt-20 grid gap-8 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <ul className="mt-6 space-y-3">
              {[
                "On-site survey & signal mapping",
                "Enterprise access points & mesh",
                "Secure VLAN & guest network setup",
            ...
            <div className="mt-8">
              <Button asChild size="lg" className="bg-gradient-brand h-12 px-6 shadow-elegant">
                <Link to="/contact">
                  Request a Site Survey <ArrowRight className="ml-1 h-4 w-4" />
                </Link>
              </Button>
            </div>
          </motion.div>
        ...
        <div className="mt-20 grid gap-8 lg:grid-cols-2 lg:items-stretch">
          ...
          >
            <img
              src={teamAntenna}
              alt="GP Smart Solutions field engineers installing a rooftop antenna and network equipment in Kampala"
              width={1320}
              height={780}
              loading="lazy"
            ...
            <div className="p-7">
              ...
              <h3 className="mt-2 text-2xl font-bold">
                Certified engineers, safety-first installs
              </h3>
          ...
          >
            <img
              src={cctvMonitoring}
              alt="Client reviewing multi-camera CCTV monitoring dashboard installed by GP Smart Solutions"
              width={1320}
              height={780}
              loading="lazy"
              className="w-full h-64 object-cover"
            ...
            <div className="p-7">
              ...
              <p className="mt-3 text-muted-foreground">
                Businesses across Kampala rely on our CCTV & remote-viewing setups for
                round-the-clock visibility of their premises — configured for phone, tablet and
                control room.
              </p>
            </div>
          </motion.div>
        ...
        <div className="mt-20 grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <div className="mt-8">
              <Button asChild size="lg" className="bg-gradient-brand h-12 px-6 shadow-elegant">
                <Link to="/contact">
                  Talk to an Engineer <ArrowRight className="ml-1 h-4 w-4" />
                </Link>
              </Button>
            </div>
          </motion.div>
        ...
        <div className="mt-20 grid gap-8 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <div className="mt-6">
              <Button asChild size="lg" className="bg-gradient-brand h-12 px-6 shadow-elegant">
                <a href="tel:+256789877929">
                  <Phone className="mr-2 h-4 w-4" /> Call +256 789 877 929
                </a>
              </Button>
            </div>
          </motion.div>
          ...
          >
            <img
              src={servicesFlyer}
              alt="GP Smart Solutions services flyer: CCTV, smart door locks, Airtel & MTN internet, attendance, PABX, POS and IT support"
              width={1400}
              height={900}
              loading="lazy"
              className="w-full h-auto object-cover"
          ...
          <div className="grid gap-6 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="mt-3 text-white/85 max-w-md">
                Tell us about your site — we'll respond with a scoped quote and timeline.
              </p>
            </div>
